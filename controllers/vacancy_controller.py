...
- Посмотреть отклики (Реализует функциональность просмотрf откликов на вакансию (view applications) из sequence диаграммы)
- Вызов метода обновитьСтатус() из модели Application
- Вызов метода закрыть() из модели Vacancy
- Вызов метода опубликовать() из модели Vacancy

- Просмотр деталей вакансии(ДОБАВИЛ)
- Мои вакансии (для работодателя)(ДОБАВИЛ)
- Редактировать вакансию(ДОБАВИЛ)
- Удалить вакансию(ДОБАВИЛ)
"""
