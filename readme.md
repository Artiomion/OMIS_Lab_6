...
В каждом файле комментариями прописано, то что должно быть в диаграммах, и что есть у меня, а так же прописаны комментарии для всех новых функций, которых не было в диаграммах.
